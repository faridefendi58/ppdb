<div id="main-content">
   ...
   <div class="container-fluid">
       <div class="row-fluid">
           <div class="span12">
               <h3 class="page-title">Link Category</h3>
               ...
               <?=anchor('link_category/create', '<i class="icon-plus"></i>', array('class' => 'btn btn-mini btn-success tooltips', 'data-placement' => 'top', 'data-original-title' => 'Add New'));?>
           </div>
       </div>
       <br>
       <?=$message;?>
                          ...
                          <table class="table table-striped table-condensed table-bordered" id="sample_1">
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><?=$row->cat_name;?></td>
                                    <td>
                                        <?=anchor('link_category/update/'.$row->cat_id, '<i class="icon-pencil"></i>', array('class' => 'btn btn-mini btn-info tooltips', 'data-placement' => 'top', 'data-original-title' => 'Edit'));?>
                                    </td>
                                </tr>
                                <?php $no++; endforeach;?>
                            </tbody>
