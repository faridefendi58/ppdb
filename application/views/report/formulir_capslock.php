...
$this->fpdf->SetX(1);
$this->fpdf->SetFont('Helvetica','',8);
$this->fpdf->Cell(5 ,0.5, strtoupper('Jalur Pendaftaran'),0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(9.7 ,0.5, strtoupper(jalur($query['jalur_id'])), 0, 'LR', 'L');

$this->fpdf->Ln(0.6);
$this->fpdf->SetX(1);
$this->fpdf->SetFont('Helvetica','',8);
$this->fpdf->Cell(5 ,0.5, strtoupper('Pilihan 1'),0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(9.7 ,0.5, strtoupper($query['pilihan_1']), 0, 'LR', 'L');

$this->fpdf->Ln(0.6);
$this->fpdf->SetX(1);
$this->fpdf->SetFont('Helvetica','',8);
$this->fpdf->Cell(5 ,0.5, strtoupper('Pilihan 2'),0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(9.7 ,0.5, strtoupper($query['pilihan_2']), 0, 'LR', 'L');

$this->fpdf->Ln(0.6);
$this->fpdf->SetX(1);
$this->fpdf->SetFont('Helvetica','',8);
$this->fpdf->Cell(5 ,0.5, strtoupper('Pilihan 3'),0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(9.7 ,0.5, strtoupper($query['pilihan_3']), 0, 'LR', 'L');

$this->fpdf->Ln(0.6);
$this->fpdf->SetX(1);
$this->fpdf->SetFont('Helvetica','',8);
$this->fpdf->Cell(5 ,0.5, strtoupper('Pilihan 4'),0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(9.7 ,0.5, strtoupper($query['pilihan_4']), 0, 'LR', 'L');

$this->fpdf->Ln(0.6);
$this->fpdf->SetX(1);
$this->fpdf->SetFont('Helvetica','',8);
$this->fpdf->Cell(5 ,0.5, strtoupper('Tanggal Pendaftaran'),0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
...
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(9.7 ,0.5, strtoupper($query['nama']), 0, 'LR', 'L');
...
$this->fpdf->Cell(9.7 ,0.5, strtoupper($jns_kelamin), 0, 'LR', 'L');
...
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(9.7 ,0.5, strtoupper($query['tmp_lahir']), 0, 'LR', 'L');
...
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(9.7 ,0.5, strtoupper(indo_date($query['tgl_lahir'])), 0, 'LR', 'L');
...
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(9.7 ,0.5, strtoupper(agama($query['agama'])), 0, 'LR', 'L');
...
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->MultiCell(10 ,0.5, strtoupper($query['alamat']));
...
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(9.7 ,0.5, (strtoupper($query['st_anak'])), 0, 'LR', 'L');
...
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(9.7 ,0.5, strtoupper($query['b_badan']), 0, 'LR', 'L');
...
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(9.7 ,0.5, strtoupper($query['t_badan']), 0, 'LR', 'L');
...
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(9.7 ,0.5, strtoupper($query['g_darah']), 0, 'LR', 'L');
...
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(9.7 ,0.5, strtoupper($query['nama_ortu']), 0, 'LR', 'L');
...
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->MultiCell(10 ,0.5, strtoupper($query['alamat_ortu']));
...
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(9.7 ,0.5, strtoupper($query['pk_nama']), 0, 'LR', 'L');
...
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(9.7 ,0.5, strtoupper($query['nama_ibu']), 0, 'LR', 'L');
...
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(9.7 ,0.5, strtoupper($query['nik_ibu']), 0, 'LR', 'L');
...
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(9.7 ,0.5, strtoupper($query['alamat_ibu']), 0, 'LR', 'L');
...
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(9.7 ,0.5, strtoupper($query['kerja_ibu']), 0, 'LR', 'L');
...
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(9.7 ,0.5, strtoupper($query['hasil_ibu']), 0, 'LR', 'L');
...
$this->fpdf->SetX(1);
$this->fpdf->SetFont('Helvetica','B' ,8);
$this->fpdf->Cell(10, 0.7, 'NILAI RAPORT SEMESTER 1', 0, 'LR', 'L');
$this->fpdf->Cell(10, 0.7, 'NILAI RAPORT SEMESTER 2', 0, 'LR', 'L');
...
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['n_bindo'], 0, 'LR', 'L');
//semester 2
$this->fpdf->Cell(5 ,0.5, 'BAHASA INDONESIA',0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['n_bindo2'], 0, 'LR', 'L');
...
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['n_bing'], 0, 'LR', 'L');
// semester 2
$this->fpdf->Cell(5 ,0.5, 'BAHASA INGGRIS',0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['n_bing2'], 0, 'LR', 'L');
...
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['n_mtk'], 0, 'LR', 'L');
// semester 2
$this->fpdf->Cell(5 ,0.5, 'MATEMATIKA',0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['n_mtk2'], 0, 'LR', 'L');
...
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['n_ipa'], 0, 'LR', 'L');
// semester 2
$this->fpdf->Cell(5 ,0.5, 'IPA',0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['n_ipa2'], 0, 'LR', 'L');
...
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['n_rata'], 0, 'LR', 'L');
// semester 2
$this->fpdf->Cell(5 ,0.5, 'RATA-RATA',0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['n_rata2'], 0, 'LR', 'L');
...
$this->fpdf->SetX(1);
$this->fpdf->SetFont('Helvetica','B' ,8);
$this->fpdf->Cell(10, 0.7, 'NILAI RAPORT SEMESTER 3', 0, 'LR', 'L');
$this->fpdf->Cell(10, 0.7, 'NILAI RAPORT SEMESTER 4', 0, 'LR', 'L');
...
$this->fpdf->Cell(5 ,0.5, 'BAHASA INDONESIA',0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['n_bindo3'], 0, 'LR', 'L');
// semester 4
$this->fpdf->Cell(5 ,0.5, 'BAHASA INDONESIA',0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['n_bindo4'], 0, 'LR', 'L');
...
$this->fpdf->Cell(5 ,0.5, 'BAHASA INGGRIS',0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['n_bing3'], 0, 'LR', 'L');
// semester 4
$this->fpdf->Cell(5 ,0.5, 'BAHASA INGGRIS',0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['n_bing4'], 0, 'LR', 'L');
...
$this->fpdf->Cell(5 ,0.5, 'MATEMATIKA',0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['n_mtk3'], 0, 'LR', 'L');
// semester 4
$this->fpdf->Cell(5 ,0.5, 'MATEMATIKA',0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['n_mtk4'], 0, 'LR', 'L');
...
$this->fpdf->Cell(5 ,0.5, 'IPA',0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['n_ipa3'], 0, 'LR', 'L');
// semester 4
$this->fpdf->Cell(5 ,0.5, 'IPA',0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['n_ipa4'], 0, 'LR', 'L');
...
$this->fpdf->Cell(5 ,0.5, 'RATA-RATA',0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['n_rata3'], 0, 'LR', 'L');
// semester 4
$this->fpdf->Cell(5 ,0.5, 'RATA-RATA',0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['n_rata4'], 0, 'LR', 'L');
...
$this->fpdf->SetX(1);
$this->fpdf->SetFont('Helvetica','B' ,8);
$this->fpdf->Cell(10, 0.7, 'NILAI UJIAN NASIONAL', 0, 'LR', 'L');
...
$this->fpdf->Cell(5 ,0.5, 'BAHASA INDONESIA',0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['nun_bindo'], 0, 'LR', 'L');
// uas
$this->fpdf->Cell(5 ,0.5, 'BAHASA INDONESIA',0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['nus_bindo'], 0, 'LR', 'L');
...
$this->fpdf->Cell(5 ,0.5, 'BAHASA INGGRIS',0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['nun_bing'], 0, 'LR', 'L');
// uas
$this->fpdf->Cell(5 ,0.5, 'BAHASA INGGRIS',0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['nus_bing'], 0, 'LR', 'L');
...
$this->fpdf->Cell(5 ,0.5, 'MATEMATIKA',0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['nun_mtk'], 0, 'LR', 'L');
// uas
$this->fpdf->Cell(5 ,0.5, 'MATEMATIKA',0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['nus_mtk'], 0, 'LR', 'L');
...
$this->fpdf->Cell(5 ,0.5, 'IPA',0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['nun_ipa'], 0, 'LR', 'L');
// uas
$this->fpdf->Cell(5 ,0.5, 'IPA',0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['nus_ipa'], 0, 'LR', 'L');
...
$this->fpdf->Cell(5 ,0.5, 'RATA-RATA',0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['nun_rata'], 0, 'LR', 'L');
// uas
$this->fpdf->Cell(5 ,0.5, 'RATA-RATA',0,'LR', 'L');
$this->fpdf->Cell(0.3 ,0.5, ':' ,0,'LR', 'L');
$this->fpdf->Cell(4.7 ,0.5, $query['nus_rata'], 0, 'LR', 'L');
